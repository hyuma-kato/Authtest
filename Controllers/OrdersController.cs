...
namespace Authtest.Controllers
{
    public class OrdersController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("Id,UserId,ProductId,Count,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ProductId,Count,OrderDate")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
